...
export default {
  ...
  title: "Evolutionary Design Groups",

  // A short description of your site, used for SEO and other metadata.
  description: "A manual on how to start and run an Evolutionary Design Group.",

  // A longer description of your site, used in the open-artifact.json file. For
  // multiple paragraphs, use \n\n to separate them.
  longDescription: "A critical part of evolving the world is making the physical changes to our communities all across the globe. Evolutionary Design Groups are a model for how to organize people to do this work in a way that is effective, inclusive, and empowering.",
  ...
  tags: ["website", "book", "eleventy", "open artifacts"],
